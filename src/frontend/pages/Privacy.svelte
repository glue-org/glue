<h1>Privacy Policy for glue</h1>

<p>
  At glue, accessible from https://r53d5-wyaaa-aaaae-qacxa-cai.ic0.app/, one of
  our main priorities is the privacy of our visitors. This Privacy Policy
  document contains types of information that is collected and recorded by glue
  and how we use it.
</p>
...
<p>
  ...
  and/or collect in glue. This policy is not applicable to any information
...
<p>
  glue follows a standard procedure of using log files. These files log visitors
...
<p>
  Like any other website, glue uses 'cookies'. These cookies are used to store
...
<p>
  ...
  advertising partners of glue.
</p>

<p>
  Third-party ad servers or ad networks uses technologies like cookies,
  JavaScript, or Web Beacons that are used in their respective advertisements
  and links that appear on glue, which are sent directly to users' browser. They
...
<p>
  Note that glue has no access to or control over these cookies that are used by
...
<p>
  glue's Privacy Policy does not apply to other advertisers or websites. Thus,
...
<p>
  glue does not knowingly collect any Personal Identifiable Information from
